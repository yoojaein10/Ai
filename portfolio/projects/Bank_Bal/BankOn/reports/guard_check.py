# human_guard 실폼 검증(읽기 전용, 저장 없음) — 관리자 권한으로 띄움. 결과: reports/guard_check.out
...
out = open(ROOT / "reports" / "guard_check.out", "w", encoding="utf-8", errors="replace", buffering=1)
...
CASES = [  # (doc, bank, APW RequestDate, 기대)
    ("01-2609-3-2780", "기업", dt.date(2026, 9, 4), "제외(사람 작성)"),
    ("01-2609-3-2776", "기업", dt.date(2026, 9, 3), "제외(이미 발송완료)"),
    ("01-2609-3-2805", "농협", dt.date(2026, 9, 8), "새 폼 통과"),
]
try:
