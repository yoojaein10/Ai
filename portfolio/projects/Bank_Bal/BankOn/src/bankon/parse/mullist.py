...
class MullistRow:
    ...
    def is_machine(self) -> bool:
        return (self.object_kind or "").strip() == "기계기구"

    @property
    def is_unit_building(self) -> bool:
        """구분건물(집합건물 호실): DABO_JONG='집합건물'. 토지건물·토지·기계기구는 False."""
        return (self.collateral_group or "").strip() == "집합건물"
