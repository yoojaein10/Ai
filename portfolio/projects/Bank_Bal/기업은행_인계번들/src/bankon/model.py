...
from .sources.scan import GongbuRow, registry_for
...
class DocumentContext:
    ...
    site_address: str | None = None        # 시군구까지 갖춘 소재지 (parse.address)
    ...
    def registry_no(self, *, kind: str | None = None, seq_no: str | None = None) -> str | None:
