...
const EvalAiReportPage = lazy(() => import("./pages/EvalAiReportPage"));
...
function PrivateRoute({ children }: { children: React.ReactNode }) {
  ...
  if (isBootstrapping) return <PageFallback />;
...
function useAuthBootstrap() {
  ...
  }, [accessToken, userId, setAccessToken, setBootstrapping, logout]);
}
              ...
              <MainLayout>
                <Suspense fallback={<PageFallback />}>
                  <Routes>
                    ...
                    <Route path="/eval/ai-report" element={<EvalAiReportPage />} />
