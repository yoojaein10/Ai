  ...
  인사: {
    ...
    groups: [
      ...
      },
      {
        ...
        label: "근로계약",
        items: [
          { path: "/contract/my", label: "내 계약서", icon: "File", keywords: ["contract", "근로", "계약서", "my"] },
          { path: "/contract/mgmt", label: "계약서 관리", icon: "File", keywords: ["contract", "hr", "관리"] },
          { path: "/contract/mgmt/new", label: "계약서 생성", icon: "File", keywords: ["contract", "new", "생성"] },
          { path: "/contract/templates", label: "템플릿 관리", icon: "Setting", keywords: ["contract", "template", "템플릿"] },
        ],
      },
    ],
  },
