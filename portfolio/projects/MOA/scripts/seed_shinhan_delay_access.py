"""신한은행 발송기한 관리(shinhanDelay) 개인 예외 — 이일우·유재인·원동하·엄기원만.

메뉴 키는 어떤 묶음(role)에도 넣지 않는다. 권한관리 화면에서도 켜고 끌 수 있고,
여기서는 기존 개인 예외를 지우지 않고 shinhanDelay 만 더한다(변경 이력 기록).
일계표 대사(seed_bank_reconcile_access)와 같은 패턴.

  python -m scripts.seed_shinhan_delay_access --dry-run
  python -m scripts.seed_shinhan_delay_access
"""
...
MENU_KEY = "shinhanDelay"
ALLOWED = [
    (813, "이일우"), (1260, "유재인"), (2012, "원동하"), (2013, "엄기원"),
]                                                  # 2026-09-02 사용자 지정
REQUESTER = 813
MEMO = "신한 발송기한 개인 예외 (2026-09-02, 이일우·유재인·원동하·엄기원만)"
